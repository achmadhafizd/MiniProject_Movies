...
import NowPlayingMoviesViewModel from "./NowPlayingMovies.viewModel";

function NowPlayingMovies() {
  const viewModel = NowPlayingMoviesViewModel();
  return (
    <div>
      <h1 className="flex font-bold text-green-700 text-2xl dark:text-white ms-3 pt-5 justify-items-center">
        <span className="text-red-500">|</span> Now Playing Movies
      </h1>
